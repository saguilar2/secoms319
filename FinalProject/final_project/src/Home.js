          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              ...
              <form class="d-flex" role="search">
                ...
                <button class="btn btn-lg btn-primary" type="submit" onClick={TransferSignIn}>{() => {
                  if (Login) {

                    this.setButtonText(User.F_Name + " " + User.L_Name);
                  } else {
                    this.setButtonText("Sign in");
                  }
            ...
            <div class="carousel-item active">
              ...
              <div class="container">
                <div class="carousel-caption text-start">
                  ...
                  <button class="btn btn-lg btn-primary" type="submit" onClick={() => { navigate("/SignUp") }}>Sign Up!</button>
                </div>
              </div>
            </div>
          </div>
